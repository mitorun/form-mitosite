<?php
// Это PHP-конфиг от MaxGraph с небольшими изменениями (улучшениями?): Добавлена строка №16: $body = ""; Убран повторяющийся тайтл №9: $title = "Тема письма"; И вероятно нужно убирать переменные отправки файлов №10: $file = $_FILES['file']; и далее.
